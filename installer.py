...
gnome_packages = ['baobab' 'cheese' 'evince' 'gdm' 'gnome-backgrounds' 'gnome-calculator' 'gnome-calendar' 'gnome-characters' 'gnome-clocks' 'gnome-color-manager' 'gnome-control-center' 'gnome-font-viewer' 'gnome-keyring' 'gnome-menus' 'gnome-music' 'gnome-photos' 'gnome-session' 'gnome-settings-daemon' 'gnome-shell' 'gnome-shell-extensions' 'gnome-software' 'grilo-plugins' 'gvfs' 'gvfs-goa' 'gvfs-google' 'gvfs-gphoto2' 'gvfs-mtp' 'gvfs-nfs' 'gvfs-smb' 'nautilus' 'orca' 'rygel' 'sushi' 'xdg-desktop-portal-gnome' 'xdg-user-dirs-gtk' 'gnome-packagekit']
hyprland_packages = ['hyprland' 'hyprpaper' 'waybar']
xfce_packages = ['exo' 'thunar' 'ristretto' 'xdg-desktop-portal-xapp' 'xfce4-appfinder' 'xfce4-artwork' 'xfce4-battery-plugin' 'xfce4-clipman-plugin' 'xfce4-datetime-plugin' 'xfce4-mount-plugin' 'xfce4-mpc-plugin' 'xfce4-notes-plugin' 'xfce4-notifyd' 'xfce4-panel' 'xfce4-power-manager' 'xfce4-screensaver' 'xfce4-session' 'xfce4-settings' 'xfce4-taskmanager' 'xfce4-whiskermenu-plugin' 'xfce4-xkb-plugin' 'xfdesktop' 'xfwm4' 'xfwm4-themes' 'gnome-software']
